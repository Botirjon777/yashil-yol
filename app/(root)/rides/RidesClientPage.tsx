          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-gray-400 font-medium text-sm mt-0.5">
                {isLoading
                  ? "Qidirilmoqda..."
                  : `${filteredRides.length} ta sayohat topildi`}
              </p>
            </div>
            {activeRoute && (
              <button
          ...
          <div className="lg:col-span-3">
            ...
            {isLoading ? (
              ...
              <div className="premium-card p-12 text-center">
                ...
                <h3 className="text-xl font-black mb-2 text-dark-text">
                  Sayohat topilmadi
                </h3>
                <p className="text-gray-400 font-medium text-sm mb-6">
                  {activeRoute
                    ? `${activeRoute.from} to ${activeRoute.to} yo'nalishi bo'yicha hozircha sayohat yo'q`
...
export default RidesClientPage;
