...
export function DriverStatusBanner({ user, isDriver }: DriverStatusBannerProps) {
  ...
  if (user?.driving_verification_status) {
    return (
      <div className={cn(
        ...
        user.driving_verification_status === "approved" && "border-success bg-success/5",
        ...
        <div className="flex items-center space-x-5">
          <div className={cn(
            ...
            user.driving_verification_status === "approved" && "bg-success/20 text-success",
          ...
          <div>
            ...
            <p className="text-sm font-bold text-gray-500 capitalize">
              {user.driving_verification_status} – {
                ...
                user.driving_verification_status === "approved" ? "Congratulations! You can now start driving." :
