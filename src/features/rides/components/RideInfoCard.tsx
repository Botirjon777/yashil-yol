...
export const RideInfoCard = ({
  ...
  return (
    <div className="premium-card overflow-hidden">
      {/* Header */}
      <div className="px-2.5 md:px-5 pt-2.5 md:pt-5 pb-2.5 md:pb-5 border-b border-border/60 flex items-center gap-3">
      ...
      <div className="p-2.5 md:p-5 space-y-2.5 md:space-y-6">
        {/* Driver avatar row */}
        {!isDriver && (
