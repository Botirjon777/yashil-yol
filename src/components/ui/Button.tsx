  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center font-black uppercase tracking-widest cursor-pointer transition-all duration-300 rounded-2xl shrink-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0",
          variants[variant],
          sizes[size],
          fullWidth && "w-full",
          className,
